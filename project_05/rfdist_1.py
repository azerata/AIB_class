...
if __name__ == "__main__":
	...
	terminal_nodes1=tree1.get_terminals(order="preorder")
	root_node=terminal_nodes1[0].name
	tree1.root_with_outgroup({"name":root_node})
	tree2.root_with_outgroup({"name":root_node})
